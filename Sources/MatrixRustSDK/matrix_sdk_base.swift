...
public struct RoomAccessRulesEventContent {
     ...
     * The rule value.
     */
    public var rule: RoomAccessRules
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RoomAccessRulesEventContent {
        return
            try RoomAccessRulesEventContent(
                rule: FfiConverterTypeRoomAccessRules.read(from: &buf)
        )
    }

    public static func write(_ value: RoomAccessRulesEventContent, into buf: inout [UInt8]) {
        FfiConverterTypeRoomAccessRules.write(value.rule, into: &buf)
    }
}
...
public struct FfiConverterTypeRoomAccessRules: FfiConverterRustBuffer {
    typealias SwiftType = RoomAccessRules

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RoomAccessRules {
    ...
    public static func write(_ value: RoomAccessRules, into buf: inout [UInt8]) {
        switch value {
...
public func FfiConverterTypeRoomAccessRules_lift(_ buf: RustBuffer) throws -> RoomAccessRules {
    return try FfiConverterTypeRoomAccessRules.lift(buf)
}

public func FfiConverterTypeRoomAccessRules_lower(_ value: RoomAccessRules) -> RustBuffer {
    return FfiConverterTypeRoomAccessRules.lower(value)
}



extension RoomAccessRules: Equatable, Hashable {}
